...
export function Likes({ id }: { id: string }) {
  ...
  return (
    <button
      onClick={handleClick}
      className='fade-in top-6 fixed sm:top-auto sm:bottom-4 right-6 bg-gray-50 border border-solid w-fit px-5 min-w-24 gap-4 py-2 border-gray-200 rounded-full flex items-center'
    >
